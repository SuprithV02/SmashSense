...
public interface UserRepository extends JpaRepository<User, Long> { //User is the entity, this repo works with and Long is the type of the primary key
    //This JpaRepository gives an Out-of-Box CRUD methods 
    Optional<User> findByUsername(String username);
    //This is a custom query method , and Spring Data Jpa is smart enough to generate the query automatically
...
// UserRepository is a DAO (Data access Object) or repository class, and this doesn't need to be a class because 
// Spring Boot handles the implementation internally cause we are extending the JpaRepository
